...
const Hero = () => {
  return (
    <div className='w-full flex flex-col justify-center md:px-40 px-4 pt-24'>
        <h1 className='md:text-7xl text-5xl tracking-tight text-center font-extrabold text-white'>Full-Stack <span className='text-yellow-400'>Developer</span> Ready to Build Your Next Big Idea</h1>
